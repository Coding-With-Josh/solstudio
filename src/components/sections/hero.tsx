...
export default async function Hero() {
  ...
  const { stargazers_count: stars } = await fetch(
    "https://api.github.com/repos/Coding-With-Josh/solstudio",
    {
      cache: "no-store",
    }
  )
      ...
      <div className="container flex w-full flex-col items-center justify-center space-y-20 py-16 md:py-20 lg:py-24 xl:py-28">
        <div className="mx-auto w-full max-w-2xl ">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mx-auto mb-5 flex max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full dark:bg-blue-600/5 dark:border-blue-600/40 border px-7 py-2 transition-colors duration-300 dark:hover:bg-blue-600/10 bg-blue-300/60"
          >
            <Icons.twitter className="h-5 w-5 text-blue-700" />
            <p className="text-sm font-semibold text-blue-700">
              {scopedT("top")} SolStudio
            </p>
          </a>
          ...
          <div className="mx-auto mt-6 flex items-center justify-center space-x-5">
            ...
            <Link
              ...
              href="https://github.com/Coding-With-Josh/solstudio"
              target="_blank"
