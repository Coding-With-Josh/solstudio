...
const ThanksTemp: React.FC<Readonly<ThanksTemplateProps>> = ({ userName }) => (
  <Html>
    <Head />
    <Preview>Welcome to SolStudio.</Preview>
    <Tailwind>
        ...
        <Container className="mx-auto my-10 bg-white">
          <Section className="my-8">
            ...
            <Text className="mx-10 text-base">
              Welcome to SolStudio. Now you can build your idea faster. You can
            ...
            <Text className="mx-10 text-base font-bold">SolStudio</Text>
          </Section>
        </Container>
      </Body>
    </Tailwind>
